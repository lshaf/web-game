      ...
      <li v-for="game in shown" :key="game.id">
        <button class="cabinet" @click="$emit('select', game.id)">
          <span class="cabinet__art" :class="'cabinet__art--' + game.id">
            ...
            <span v-else-if="game.id === 'sortir'" class="cabinet__icon cabinet__sortir" aria-hidden="true">
              <svg viewBox="0 0 46 46">
            ...
            <span v-else-if="game.id === 'yatzy'" class="cabinet__icon cabinet__yatzy" aria-hidden="true">
              <svg viewBox="0 0 46 46">
            ...
            <span v-else-if="game.id === 'sambung'" class="cabinet__icon cabinet__sambung" aria-hidden="true">
              <svg viewBox="0 0 46 46">
            ...
            <span v-else-if="game.id === 'tangga'" class="cabinet__icon cabinet__tangga" aria-hidden="true">
              <svg viewBox="0 0 46 46">
                <g stroke="var(--ink)" stroke-width="2.4">
            ...
            <span v-else-if="game.id === 'onet'" class="cabinet__icon cabinet__onet" aria-hidden="true">
              <svg viewBox="0 0 46 46">
                <g stroke="var(--ink)" stroke-width="2.4">
            ...
            <span v-else-if="game.id === 'takuzu'" class="cabinet__icon cabinet__takuzu" aria-hidden="true">
              <svg viewBox="0 0 46 46">
                <g stroke="var(--ink)" stroke-width="2">
